  ...
  <!-- navbar -->
    ...
    <div class="row">
        <div class="row video-section">
          <h1 class="card-panel white-text center">Video</h1>
        </div>

        <div class="col l12 m12 center" style="margin-top: 30px">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/RQeVktJcbHA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>

        <div class="col l12 m12 center" style="margin-top: 50px">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/arpaZ4IQrHQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>

         <div class="col l12 m12 center" style="margin-top: 50px">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/-6JXS1V0ac0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
    </div>
    <!-- akhir video -->
    ...
    <footer class="page-footer footer-section">
      ...
      <div class="footer-copyright">
        <div class="container">
          <a href="#"><p class="valign center">© 2018 Copyright Museum Tekstil</p></a>
        </div>
      </div>
    </footer>
    <!-- akhir footer -->
