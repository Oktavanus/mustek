...
<body class="scrollspy" id="home">
  ...
  <!-- navbar -->
    ...
    <!-- tentang pariwisata -->
        ...
        <div class="row about3-section">
          <h1 class="card-panel white-text center">Hubungi Kami</h1>

          <div class="row">
            <div class="col l12 center-align">
              <img src="img/home/tekstil.jpg" class="responsive-img">
            </div>
            
            <div class="col l6 push-l3">
              <h5>Alamat Kantor :</h5>
              <p>Jl. Aipda KS. Tubun No.2-4, RT.4/RW.2 <br>   Kota Bambu Sel, Palmerah, Kota Jakarta Barat <br>Daerah Khusus Ibukota Jakarta 11420</p>
              <h5>Nomor Telepon :</h5>
              <p>(021) 560 6613</p>
              <h5>Fax :</h5>
              <p>(021) 565 4401</p>
              <h5>E-mail :</h5>
              <p>mus_tekstil@yahoo.co.id</p>
            </div>

             <div class="col l6 push-l1">
              <h5>Jam Buka Museum :</h5>
              <p>• Hari Selasa - Minggu : 09.00 - 15.00 WIB <br>
                 • Haris Senin dan Libur Nasional : Tutup</p>
              <h5>Jam Buka Workshop Batik</h5>
              <p>• Hari Selasa - Minggu : 09.00 - 15.00 WIB <br>
                 • Haris Senin dan Libur Nasional : Tutup</p>
              <h5>Workshop Pewarnaan Alami</h5>
              <p>Dengan Perjanjian Terlebih Dahulu</p>
            </div>
